...
variable "rhcos_installer_initramfs" {
  description = "URL to the RedHat CoreOS installer initramfs"
  type = "string"
}

variable "rhcos_installer_kernel" {
  description = "URL to the RedHat CoreOS installer kernel"
  type = "string"
}
variable "rhcos_metal_bios" {
  description = "URL to the RedHat CoreOS metal bios archive"
  type = "string"
}
